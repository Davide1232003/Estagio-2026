    ...
    <div className="min-h-screen bg-slate-300 flex flex-col">
      <header className="bg-white shadow-sm">
        <div className="max-w-5xl mx-auto px-4 py-3 flex justify-center items-center">
          <h1 className="text-gray-600 text-2xl font-normal">Tradutor</h1>
        </div>
      </header>
        ...
        <div className="w-full max-w-5xl bg-white rounded-lg shadow-md overflow-hidden">
          <div className="flex items-center justify-between p-4 border-b border-gray-200">
            <select
              ...
              className="text-sm text-gray-600 bg-transparent border-none focus:outline cursor-pointer"
            >
              {languages.map((lang) => (
            ...
            <button
              ...
              className="p-3 rounded-full hover:bg-gray-100 outline-none"
            >
              <svg
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-4">
              <textarea
                ...
                className="w-full h-40 text-lg text-gray-600 bg-transparent resize-none border-none outline-none"
              ></textarea>
            </div>
            ...
            <div className="p-4 relative bg-gray-200 border-l border-gray-200">
              {isLoading ? (
                ...
                <p className="text-lg text-gray-600">{transletedText}</p>
              )}
              {/* ?-if :-else */}
            </div>
          </div>
      ...
      <footer className="bg-white border-t border-gray-200 mt-auto">
        <div className="max-2-5xl mx-auto px-4 py-3 text-sm text-gray-600">
          &copy; {new Date().getFullYear()} Tradutor App
        </div>
      </footer>
    </div>
  );
